...
public class DefaultAppleAppAttestValidationService implements AppleAppAttestValidationService {
    ...
    public AppleAppAttestUser validateAttestation(String keyId, String attestation, String challenge) throws AuthenticationException {
        try {
    ...
    @Override
    @SuppressWarnings("unchecked")
    public AppleAppAttestUser validateAssertion(String keyId, String assertion, String challenge) throws AuthenticationException {
        try {
            // Step 1: Load the stored key credential
            AppleAppAttestKeyCredential storedCredential = this.keyCredentialService.getKeyCredential(keyId);
            ...
            if (unsignedCounter <= storedCredential.getSignCount()) {
            ...
            sig.initVerify(storedCredential.getPublicKey());
            sig.update(nonce);
            ...
            this.keyCredentialService.updateSignCount(keyId, unsignedCounter);
