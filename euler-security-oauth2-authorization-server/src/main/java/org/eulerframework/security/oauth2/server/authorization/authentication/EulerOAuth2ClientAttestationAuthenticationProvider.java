...
public final class EulerOAuth2ClientAttestationAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(@Nonnull Authentication authentication) throws AuthenticationException {
        ...
        if (EulerOAuth2ClientAttestationType.JWT.equals(auth2ClientAttestationType)) {
            ...
            ClientAttestationVerifier.PopVerificationResult result = attestationJwt == null
                    ? this.clientAttestationVerifier.verify(attestationPopJwt)
                    : this.clientAttestationVerifier.verify(attestationJwt, attestationPopJwt);
