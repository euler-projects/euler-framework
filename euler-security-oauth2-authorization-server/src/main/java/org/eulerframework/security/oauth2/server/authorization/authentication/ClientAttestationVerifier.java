 ...
 *       {@link AppAttestRegistrationService}.</li>
 * </ul>
 * <p>
...
public final class ClientAttestationVerifier {
     ...
     * {@link AppAttestRegistration} and its public key from
     * {@link AppAttestRegistrationService}.
     *
     * @param popJwt the PoP JWT (Section 5.2)
     * @return the verification result containing keyId, clientId and registration
     * @throws OAuth2AuthenticationException if verification fails
    ...
    public PopVerificationResult verify(String popJwt) {
        ...
        try {
            ...
            AppAttestRegistration registration = this.appAttestRegistrationService.findByKeyId(kid);
     ...
     * client ID, and the associated {@link AppAttestRegistration}.
     *
     ...
     * @param registration the {@link AppAttestRegistration} associated with the key,
