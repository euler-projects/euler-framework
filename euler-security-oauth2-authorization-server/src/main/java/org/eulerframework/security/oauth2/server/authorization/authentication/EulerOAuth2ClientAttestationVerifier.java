 ...
 *       {@link DeviceAttestRegistrationService}.</li>
 * </ul>
 * <p>
 * Both methods return a {@link PopVerificationResult} containing the resolved {@code keyId},
 * {@code clientId}, and {@link DeviceAttestRegistration}.
 *
...
public final class EulerOAuth2ClientAttestationVerifier {
    ...
    private DeviceAttestRegistrationService deviceAttestRegistrationService;
    ...
    public void setDeviceAttestRegistrationService(DeviceAttestRegistrationService deviceAttestRegistrationService) {
     ...
     * {@link DeviceAttestRegistration} and its public key from
     * {@link DeviceAttestRegistrationService}.
     *
     * @param popJwt the PoP JWT (Section 5.2)
    ...
    public PopVerificationResult verify(String popJwt) {
        ...
        if (this.deviceAttestRegistrationService == null) {
        ...
        try {
            ...
            DeviceAttestRegistration registration = this.deviceAttestRegistrationService.findByKeyId(kid);
     ...
     * client ID, and the associated {@link DeviceAttestRegistration}.
     *
     ...
     * @param registration the {@link DeviceAttestRegistration} associated with the key,
     *                     or {@code null} if resolved from attestation JWT cnf (future)
     */
    public record PopVerificationResult(
            String keyId,
            @Nullable String clientId,
            @Nullable DeviceAttestRegistration registration) {
    }
}
