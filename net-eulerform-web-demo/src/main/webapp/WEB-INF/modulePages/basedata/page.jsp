...
<body class="easyui-layout">
        ...
        <table id="dg" class="easyui-datagrid" 
            ...
            <thead>
                <tr>
                    ...
                    <th data-options="field:'requireAuthority',align:'center'">${euler:i18n('codeTable.description')}</th>
                    <th data-options="field:'pages',align:'center',formatter:unixDateFormatter">${euler:i18n('codeTable.description')}</th>
                </tr>
            </thead>
        </table>
    ...
    <script>
        $(function(){ 
            console.log(getQueryString('moduleId'));
        ...
        function unixDateFormatter(value, row, index) {
            return "<a href='#' onClick='editPages(\""+row.id+"\")'>模块页面编辑</a>";
        }
        ...
        function editPages(id) {
            ...
            for(var x in rows){
                if(rows[x].id == id){
                    addTab('basedata/page', '模块页面编辑-'+rows[x].name);
                }
            }
        }
