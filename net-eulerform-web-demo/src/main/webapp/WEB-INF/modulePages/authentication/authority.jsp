    ...
    <div data-options="region:'center'" style="background:#eee;">
        ...
        <div id="dlg" class="easyui-dialog dlg-window" style="width:400px;"
            ...
            <form id="fm" class="dlg-form" method="post">
                ...
                <div class="dlg_line"><label class="dlg_label">${euler:i18n('authority.name')}</label><span class="dlg_span"><input class="easyui-textbox dlg-input" data-options="required:true" id="dlg_name" name="name"></span></div>
                <div class="dlg_line"><label class="dlg_label">${euler:i18n('authority.authority')}</label><span class="dlg_span"><input class="easyui-textbox dlg-input" data-options="required:true" id="dlg_authority" name="authority"></span></div>
                <div class="dlg_line"><label class="dlg_label">${euler:i18n('authority.description')}</label><span class="dlg_span"><input class="easyui-textbox dlg-input" data-options="" id="dlg_description" name="description"></span></div>
            </form>
        </div>        
    </div>
