...
public abstract class EulerSecurityEndpoints {
    ...
    public static final String LOGIN_METHODS_ENDPOINT_PROP_PREFIX = PROPERTY_NAME_PREFIX + "." + "login-methods";
    public static final String LOGIN_METHODS_DISPATCH_ENDPOINT_PROP_PREFIX = LOGIN_METHODS_ENDPOINT_PROP_PREFIX + "." + "dispatch";
    public static final String LOGIN_METHODS_DISCOVERY_ENDPOINT_PROP_PREFIX = LOGIN_METHODS_ENDPOINT_PROP_PREFIX + "." + "discovery";
    ...
    public static final String USER_LOGIN_PAGE_METHODS_PROP_NAME = USER_ENDPOINT_PROP_PREFIX + "." + "login-page-methods";
    ...
    public static final String LOGIN_METHODS_DISPATCH_ENABLED_PROP_NAME = LOGIN_METHODS_DISPATCH_ENDPOINT_PROP_PREFIX + "." + ENABLED_PROP;
    public static final String LOGIN_METHODS_DISPATCH_PROCESSING_URL_PROP_NAME = LOGIN_METHODS_DISPATCH_ENDPOINT_PROP_PREFIX + "." + "processing-url";
    public static final String LOGIN_METHODS_DISPATCH_METHOD_PARAMETER_PROP_NAME = LOGIN_METHODS_DISPATCH_ENDPOINT_PROP_PREFIX + "." + "method-parameter";

    public static final String LOGIN_METHODS_DISCOVERY_ENABLED_PROP_NAME = LOGIN_METHODS_DISCOVERY_ENDPOINT_PROP_PREFIX + "." + ENABLED_PROP;
    public static final String LOGIN_METHODS_DISCOVERY_FETCHING_URL_PROP_NAME = LOGIN_METHODS_DISCOVERY_ENDPOINT_PROP_PREFIX + "." + "fetching-url";
    ...
    public static final String CSRF_FETCHING_URL_PROP_NAME = CSRF_ENDPOINT_PROP_PREFIX + "." + "fetching-url";
    ...
    public static final boolean LOGIN_METHODS_DISPATCH_ENABLED = true;
    public static final String LOGIN_METHODS_DISPATCH_PROCESSING_URL = "/login";

    public static final boolean LOGIN_METHODS_DISCOVERY_ENABLED = false;
    public static final String LOGIN_METHODS_DISCOVERY_FETCHING_URL = "/login-methods";

    /**
     * Default name of the request parameter selecting the login method
     * on the unified dispatch entry point; configurable via
     * {@code euler.security.web.endpoint.login-methods.dispatch.method-parameter}.
     * Its value is a login-method key.
     */
    public static final String LOGIN_METHODS_DISPATCH_METHOD_PARAMETER = "_m";
    ...
    public static final String CSRF_FETCHING_URL = "/_csrf";
}
