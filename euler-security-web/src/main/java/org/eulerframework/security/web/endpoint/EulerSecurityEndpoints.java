...
public abstract class EulerSecurityEndpoints {
    ...
    public static final String LOGIN_METHOD_DISPATCH_ENDPOINT_PROP_PREFIX = PROPERTY_NAME_PREFIX + "." + "login-method-dispatch";
    ...
    public static final String LOGIN_METHOD_DISPATCH_ENABLED_PROP_NAME = LOGIN_METHOD_DISPATCH_ENDPOINT_PROP_PREFIX + "." + ENABLED_PROP;
    public static final String LOGIN_METHOD_DISPATCH_PROCESSING_URL_PROP_NAME = LOGIN_METHOD_DISPATCH_ENDPOINT_PROP_PREFIX + "." + "processing-url";
    public static final String LOGIN_METHOD_DISPATCH_METHOD_PARAMETER_PROP_NAME = LOGIN_METHOD_DISPATCH_ENDPOINT_PROP_PREFIX + "." + "method-parameter";
    ...
    public static final boolean LOGIN_METHOD_DISPATCH_ENABLED = true;
    public static final String LOGIN_METHOD_DISPATCH_PROCESSING_URL = "/login";

    /**
     * Default name of the request parameter selecting the login method
     * on the unified dispatch entry point; configurable via
     * {@code euler.security.web.endpoint.login-method-dispatch.method-parameter}.
     * Its value is a login-method key.
     */
    public static final String LOGIN_METHOD_DISPATCH_METHOD_PARAMETER = "_m";
