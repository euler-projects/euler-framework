...
public abstract class SecurityConfig {
    ...
    public static String getPhoneFormat() {
        return propertyReader.getString(SecurityConfigKey.SECURITY_SIGNUP_PHONE_FORMAT, SecurityConfigDefault.SECURITY_SIGNUP_PHONE_FORMAT);
    }
    ...
    public static boolean isEnablePhoneSignin() {
        return propertyReader.getBooleanValue(SecurityConfigKey.SECURITY_AUTHENTICATION_ENABLE_PHONE_SIGNIN, SecurityConfigDefault.SECURITY_AUTHENTICATION_ENABLE_PHONE_SIGNIN);
    }
    ...
    public static boolean isEnablePhoneAutoSignup() {
        return propertyReader.getBooleanValue(SecurityConfigKey.SECURITY_SIGNUP_ENABLE_PHONE_AUTO_SIGNUP,
