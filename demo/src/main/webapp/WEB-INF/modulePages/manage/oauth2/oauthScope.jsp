...
<body class="easyui-layout">
    ...
    <div data-options="region:'center'" style="background:#eee;">
        ...
        <table id="dg" class="easyui-datagrid" 
            ...
            <thead>
                <tr>
                    ...
                    <th data-options="field:'scope',align:'center',width:'200px'">${euler:i18n('scope.scope')}</th>
                    <th data-options="field:'name',align:'center',width:'200px'">${euler:i18n('scope.name')}</th>
                    <th data-options="field:'description',align:'center',width:'200px'">${euler:i18n('scope.description')}</th>
                </tr>
            </thead>
        </table>
        <div id="dlg" class="easyui-dialog dlg-window" style="width:400px;"
            ...
            <form id="fm" class="dlg-form" method="post">
                ...
                <div class="dlg-line"><span class="dlg-label-span"><label class="dlg-label">${euler:i18n('scope.scope')}</label></span><span class="dlg-input-span"><input class="easyui-textbox dlg-input" data-options="required:true,prompt:'${euler:i18n('global.uppercaseLettersOrUnderscore')}'" id="dlg_scope" name="scope"></span></div>
                <div class="dlg-line"><span class="dlg-label-span"><label class="dlg-label">${euler:i18n('scope.name')}</label></span><span class="dlg-input-span"><input class="easyui-textbox dlg-input" data-options="required:true" id="dlg_name" name="name"></span></div>
                <div class="dlg-line"><span class="dlg-label-span"><label class="dlg-label">${euler:i18n('scope.description')}</label></span><span class="dlg-input-span"><input class="easyui-textbox dlg-input" data-options="" id="dlg_description" name="description"></span></div>
                </div>
            </form>
        </div>        
    </div>
    ...
    <script>    
        ...
        function onAdd() {
            $('#fm').form('clear');
            $('#dlg').dialog('open').dialog('setTitle', "${euler:i18n('jsp.scope.addScope')}");
        }
        ...
        function onEdit() {
            ...
            if(row == null || row.length < 1){
                ...
                $('#fm').form('load', row[0]);
                $('#dlg').dialog('open').dialog('setTitle', "${euler:i18n('jsp.scope.editScope')}");
