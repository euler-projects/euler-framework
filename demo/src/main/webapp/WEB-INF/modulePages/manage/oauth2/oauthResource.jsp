    ...
    <div data-options="region:'center'" style="background:#eee;">
        ...
        <div id="dlg" class="easyui-dialog dlg-window" style="width:400px;"
            ...
            <form id="fm" class="dlg-form" method="post">
                ...
                <div class="dlg-line"><span class="dlg-label-span"><label class="dlg-label">${euler:i18n('resource.resourceId')}</label></span><span class="dlg-input-span"><input class="easyui-textbox dlg-input" data-options="required:true,prompt:'${euler:i18n('global.lettersOrNumbers')}'" id="dlg_resourceId" name="resourceId"></span></div>
                <div class="dlg-line"><span class="dlg-label-span"><label class="dlg-label">${euler:i18n('resource.name')}</label></span><span class="dlg-input-span"><input class="easyui-textbox dlg-input" data-options="required:true" id="dlg_name" name="name"></span></div>
                <div class="dlg-line"><span class="dlg-label-span"><label class="dlg-label">${euler:i18n('resource.description')}</label></span><span class="dlg-input-span"><input class="easyui-textbox dlg-input" data-options="" id="dlg_description" name="description"></span></div>
                </div>
            </form>
        </div>        
    </div>
