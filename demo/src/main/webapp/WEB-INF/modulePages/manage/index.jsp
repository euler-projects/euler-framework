...
<body class="easyui-layout">
    ...
    <div id="footer-zone" data-options="region:'south',split:false,collapsible:false">
        <div id="footer">Powered&nbsp;by&nbsp;eulerframework&nbsp;${eulerframeworkVersion}&nbsp;&copy;<%=new SimpleDateFormat("yyyy").format(new Date()) %>&nbsp;cFrost&nbsp;<a id="icp" href="http://www.miitbeian.gov.cn" target="_Blank">粤ICP备15054669号</a></div>
    </div>
