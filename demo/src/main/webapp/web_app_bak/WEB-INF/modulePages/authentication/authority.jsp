    ...
    <div data-options="region:'center'" style="background:#eee;">
        ...
        <div id="dlg" class="easyui-dialog dlg-window" style="width:400px;"
            ...
            <form id="fm" class="dlg-form" method="post">
                ...
                <div class="dlg-line"><span class="dlg-label-span"><label class="dlg-label">${euler:i18n('authority.authority')}</label></span><span class="dlg-input-span"><input class="easyui-textbox dlg-input" data-options="required:true" id="dlg_authority" name="authority"></span></div>
